...
copilot init --app container-observability-app --type "Load Balanced Web Service" --name ecsdemo-frontend --dockerfile "./Dockerfile" --deploy 
...
EOF
copilot deploy --app container-observability-app --name ecsdemo-frontend

cd ~/environment/ecsdemo-nodejs
copilot init --app container-observability-app --type "Backend Service" --name ecsdemo-nodejs --dockerfile "./Dockerfile" --deploy 

cd ~/environment/ecsdemo-crystal
git rev-parse --short=7 HEAD > code_hash.txt
copilot init --app container-observability-app --type "Backend Service" --name ecsdemo-crystal --dockerfile "./Dockerfile" --deploy 
