...
if ! $(aws ecs list-services --cluster container-observability-ecs-cluster --query "serviceArns[*]" --output text | grep -w -q container-observability-ecs-cluster-adot); then
    ...
    aws ecs create-service \
        ...
        --service-name container-observability-ecs-cluster-adot \
...
echo "Created ECS service named container-observability-ecs-cluster-adot"
