...
if ! $(aws ecs list-services --cluster container-observability-ecs-cluster --query "serviceArns[*]" --output text | grep -w -q container-observability-ecs-cluster-firelens); then
    ...
    aws ecs create-service \
        --cluster container-observability-ecs-cluster \
        --service-name container-observability-ecs-cluster-firelens \
...
echo "Created ECS service named container-observability-ecs-cluster-firelens"
